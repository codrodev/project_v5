...
public class WelcomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFont = Typeface.createFromAsset(getAssets(), "Dubai-Regular.ttf");
        ...
        layout_titles = new String[]{getResources().getString(R.string.slide_1_title),getResources().getString(R.string.slide_2_title),getResources().getString(R.string.slide_3_title),getResources().getString(R.string.slide_4_title),getResources().getString(R.string.slide_5_title),};
        ...
        ImageButton imgButton=(ImageButton)findViewById(R.id.btnBack);
    ...
    private void addBottomDots(int currentPage) {
        ...
        names= new TextView[layouts.length];
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            //names[i].setText(layout_titles[i]);
            //names[i].setTypeface(myFont);
        }
        if (dots.length > 0)
    ...
    private void launchHomeScreen() {
        if (PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getBoolean(IS_FIRST_TIME_LAUNCH,true)) {
            PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).edit().putBoolean(IS_FIRST_TIME_LAUNCH, false).apply();
