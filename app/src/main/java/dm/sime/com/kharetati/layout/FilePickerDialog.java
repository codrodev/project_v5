...
import dm.sime.com.kharetati.Adapter.FileListAdapter;
import dm.sime.com.kharetati.R;
import dm.sime.com.kharetati.model.DialogConfigs;
import dm.sime.com.kharetati.model.DialogProperties;
import dm.sime.com.kharetati.model.FileListItem;
import dm.sime.com.kharetati.model.MarkedItemList;
import dm.sime.com.kharetati.services.DialogSelectionListener;
import dm.sime.com.kharetati.services.NotifyItemChecked;
import dm.sime.com.kharetati.util.Constant;
import dm.sime.com.kharetati.util.ExtensionFilter;
import dm.sime.com.kharetati.util.Utility;
import dm.sime.com.kharetati.widget.MaterialCheckbox;
...
public class FilePickerDialog extends Dialog implements AdapterView.OnItemClickListener {
        ...
        mFileListAdapter.setNotifyItemCheckedListener(new NotifyItemChecked() {
            ...
            public void notifyCheckBoxIsClicked() {
                positiveBtnNameStr = positiveBtnNameStr == null ?
                        context.getResources().getString(R.string.choose_label) : positiveBtnNameStr;
                int size = MarkedItemList.getFileCount();
                if (size == 0) {
                    select.setEnabled(false);
                    int color;
    ...
    protected void onStart() {
        ...
        positiveBtnNameStr = (
                ...
                context.getResources().getString(R.string.choose_label) :
                positiveBtnNameStr
        );
        select.setText(positiveBtnNameStr);
    ...
    public void show() {
        if (!Utility.checkStorageAccessPermissions(context)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ((Activity) context).requestPermissions(Constant.PERMISSIONS_STORAGE, Constant.REQUEST_READ_EXTERNAL_STORAGE);
            }
        } else {
            super.show();
            positiveBtnNameStr = positiveBtnNameStr == null ?
