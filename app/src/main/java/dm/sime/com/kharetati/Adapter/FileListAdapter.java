...
import dm.sime.com.kharetati.widget.OnCheckedChangeListener;
...
public class FileListAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (item.isDirectory()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                holder.type_icon.setColorFilter(context.getResources().getColor(R.color.accent,context.getTheme()));
            }
            else
            {   holder.type_icon.setColorFilter(context.getResources().getColor(R.color.accent));
            }
